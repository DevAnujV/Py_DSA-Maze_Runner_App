...
class MinHeapTestCase(unittest.TestCase):
    ...
    def test_insert_duplicate_elements(self):
        print("test_insert_duplicate_elements")
        heap = MinHeap()
        heap.insert(1)
        heap.insert(2)
        heap.insert(3)
    ...
    def test_extract_from_empty_heap(self):
        print("test_extract_from_empty_heap")
        heap = MinHeap()
        self.assertIsNone(heap.extract_min())

    def test_create_empty_heap(self):
        print("test_create_empty_heap")
        heap = MinHeap([])
        self.assertIsNone(heap.extract_min())

    def test_create_heap_with_single_element(self):
        print("test_create_heap_with_single_element")
        heap = MinHeap([1])
        self.assertEqual(heap.extract_min(), 1)
        self.assertIsNone(heap.extract_min())

    def test_insert_one_element(self):
        print("test_insert_one_element")
        heap = MinHeap()
        heap.insert(5)
        self.assertEqual(heap.get_min(), 5)

    def test_insert_multiple_elements(self):
        print("test_insert_multiple_elements")
        heap = MinHeap()
        heap.insert(5)
        heap.insert(3)
        heap.insert(7)
    ...
    def test_extract_min_empty_heap(self):
        print("test_extract_min_empty_heap")
        heap = MinHeap()
        min_val = heap.extract_min()
